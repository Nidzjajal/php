...
<div class="container bg-info text-dark mt-4  p-4  w-50">
        <form method="POST">
            <!-- <div class="row">
                <div class="col-12 text-center text-danger border-bottom p-3">PROGRAM PATTERN 1</div>
            </div> -->
            <h2 class="text-center text-danger border-bottom"> PROGRAM PATTERN 1 </h2>
            <div class="row p-1">
...
if(isset($_POST['btn']))
{
    ...
    echo"<div class='bg-warning text-pyramid m-2 p-3 '>";
    echo"Pyramid";
    echo"</div>";
    echo"<br>";
   // $no=6;
